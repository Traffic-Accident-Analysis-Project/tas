	...
	<div class="container">
		...
		<div class="bottom-background-color">
			<div class="re-my-info-wrap">
				<h1>내 정보 수정</h1>
				<!-- 기존 정보가 적혀있어야 함-->
				<label for="userName">이름</label> <input id="userName" type="text" />
				<label for="password">비밀번호</label> <input id="password"
					type="password" /> <label for="rePassword">비밀번호 재확인</label> <input
					id="rePassword" type="password" /> <label for="email-id">e-mail주소</label>
				...
				<input id="email-user-write-box" type="text" style="display: none"
					placeholder="ex) @email.com" /> <label for="addr">주소</label>
				...
				<!-- 회원탈퇴 추가 -->
				<button id="secession-btn" type="button">회원탈퇴</button>
